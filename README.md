...
- 이형준 : 같은 학원 클래스의 학생들과 처음 팀을 이뤄 처음 프로젝트를 진행하면서 많은 시행착오를 격었고 커뮤니케이션에 대해서도 문제가 없진 않았지만 같이 문제를 하나씩 해결해 나가며 코드 작성에대한 이해를 조금 더 알 수 있던거같습니다. 이러한 점들을 생각해 다음 파이널프로젝트나 개인적으로 공부를 할 때 조금 더 배운 내용들을 적절하게 적용하고 공부하여 업무능력 향상과 진행하는 프로젝트 코딩의흐름 그리고 가독성과 보안성 등을 조금더 보안해 만들어 보고 싶은 생각을 했습니다.
